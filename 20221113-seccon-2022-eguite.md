...
We are given an ELF and EXE file (the same challenge - you can pick your enemy) with the simple task to crack its license.
...
We do similar starting from character 20 and taking 6 -> `second_num`, starting from 27 and taking 6 -> `third_num` and for the last group from 34th character spanning for 8 characters -> `fourth_num`.
