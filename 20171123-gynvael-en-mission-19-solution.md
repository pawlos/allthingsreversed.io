...
In this mission we are given a CHIP-8 ROM image. This is clearly a reference to the latest streams about this topic ([#34](https://www.youtube.com/watch?v=BQRX3owv2JI), [#35](https://www.youtube.com/watch?v=locDS3uHv_E), [#36](https://www.youtube.com/watch?v=9xGgZUMNl2Y), [#37](https://www.youtube.com/watch?v=adHOlKKbFXM), [#38](https://www.youtube.com/watch?v=0sphPKO8QTs)). If you don't know what Chip-8 is I recommend watching those.

To be able to solve this challenge what we needs is a debugger or at least a decompiler. What my first though was, was to check r2 for a plugin that would support Chip8. Unfortunately there was none.

What I found at first was a [Chip-8 decompiler](https://github.com/bloody76/Chip8-Disassembler). It worked ok, and I got a disassembly for the crack me.

[View Gist](https://gist.github.com/pawlos/1f70ed123bfd1ca1a05f3fa82cbad596)

I've tried analyzing it a bit but gave up pretty quickly as it was too difficult to do manually.
...
What is good about this tool is that it shows the disassembly as well as the output and registers. Everything what's needed.
